...
export interface Message<C extends BaseContent = Content> {
    id: string;
    author: Author;
...
export interface UnknownContent extends BaseContent {
    ...
    content_type: Exclude<string, "text" | "code" | "thoughts" | "user_editable_context" | "model_editable_context" | "reasoning_recap">;
    [key: string]: unknown;
}
export {};
